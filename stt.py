...
segments, info = model.transcribe("tts.mp3" , word_timestamps=True)
...
change_settings({"IMAGEMAGICK_BINARY": r"C:\\Program Files\\ImageMagick-6.9.12-Q16-HDRI\\magick.exe"})  
